...
class Pengeluaran extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tanggal, kwitansi, jumlah, keterangan', 'required'),
			...
			array('last_update, create_at', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, tanggal, kwitansi, jumlah, keterangan, create_at, last_update', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		$sql = "SELECT sum(`jumlah`) as `total` FROM tbl_pengeluaran WHERE `tanggal` LIKE '".$kondisi."-%'";
